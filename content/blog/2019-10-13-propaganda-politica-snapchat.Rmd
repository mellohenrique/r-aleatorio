...
x <- numeric(35)
for (i in 1:35) {
  x[i] <- sum(i >= faixa_idade$min & i <= faixa_idade$max, na.rm = TRUE)
}
...
Um exercício simples. Os resultados condizem com o esperado anteriomente, pretendo voltar a fazer algumas análises nesta base de dados. 
